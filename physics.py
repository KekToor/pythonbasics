...
'''
Tato třída je nutná k funkci switche; jelikož jsem zvyklý na C tak jsem se pokusil použít něco podobného,
implementace něčeho podobného switchi v Pythonu bude totiž až ve verzi 3.10 (match)
'''
class switch(object):
    value = None
...
print(gravitacnisila.__doc__)
gravitacnisila()

print(cascesty.__doc__)
cascesty()

print(letadlo.__doc__)
letadlo()